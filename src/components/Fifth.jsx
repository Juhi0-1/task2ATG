...
import './style.css'
import fifthtext from './images/fifthtext.png';
    ...
    return (
      <>
       ...
       <div ref={firsthalf} className='main'>
        ...
        <div ref={secpic} className='bg-gray-300 h-screen flex flex-row relative'>
          {/* h-full w-96 */}
          <img 
          src={fifthtext} alt='straight' className=' absolute h-full w-full opacity-0  fadeIn'/>
          {/* <img 
